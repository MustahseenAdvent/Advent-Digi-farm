...
--
-- Table structure for table `sensorpackagedata`
--

DROP TABLE IF EXISTS `sensorpackagedata`;
CREATE TABLE IF NOT EXISTS `sensorpackagedata` (
  `temp` int NOT NULL,
  `soil_temp` int NOT NULL,
  `humidity` int NOT NULL,
  `pressure` int NOT NULL,
  `elec_conductivity` int NOT NULL,
...
--
-- Dumping data for table `sensorpackagedata`
--

INSERT INTO `sensorpackagedata` (`temp`, `soil_temp`, `humidity`, `pressure`, `elec_conductivity`, `wind_speed`, `id`) VALUES
(64, 61, 45, 1010, 1, 5, 1),
(66, 65, 48, 1009, 1, 4, 2),
(75, 72, 59, 1011, 1, 6, 3);
